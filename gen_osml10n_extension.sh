...
if ! [ -f "country_osm_grid.sql" ]; then
  ...
  curl -sL -A "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.0.0 Safari/537.36" https://www.nominatim.org/data/country_grid.sql.gz |gzip -d >country_osm_grid.sql  
